 ...
 The following SQL statements will be executed:
     ...
     CREATE TABLE MedicalService (id INT IDENTITY NOT NULL, name NVARCHAR(50) NOT NULL, price INT NOT NULL, noOfPatients INT NOT NULL, noOfRooms INT NOT NULL, PRIMARY KEY (id));
     CREATE TABLE Room (number INT NOT NULL, type NVARCHAR(50) NOT NULL, noOfStaffs INT NOT NULL, medicalService_id INT, PRIMARY KEY (number, type));
     CREATE INDEX IDX_D2ADFEA51AEE5591 ON Room (medicalService_id);
     CREATE TABLE Visit (id INT IDENTITY NOT NULL, prescription_id INT, totalCost INT NOT NULL, payMethod NVARCHAR(4) NOT NULL, paid BIT NOT NULL, checkIn DATETIME2(6) NOT NULL, checkOut DATETIME2(6), byPatient_id INT, requestedService_id INT, PRIMARY KEY (id));
     ...
     CREATE TABLE Prescription (id INT IDENTITY NOT NULL, totalCost INT NOT NULL, prescribeFor INT NOT NULL, prescribedBy_id INT, PRIMARY KEY (id));
     CREATE INDEX IDX_78E632124ED775C ON Prescription (prescribedBy_id);
     CREATE TABLE MedicalStaff (id INT IDENTITY NOT NULL, ssn NVARCHAR(30) NOT NULL, name NVARCHAR(30) NOT NULL, gender NVARCHAR(7) NOT NULL, dob DATE NOT NULL, age INT NOT NULL, phone NVARCHAR(12) NOT NULL, role NVARCHAR(30) NOT NULL, yearOfExperience INT NOT NULL, specialty NVARCHAR(30) NOT NULL, assignRoomNo INT, assignRoomType NVARCHAR(50), PRIMARY KEY (id));
     CREATE INDEX IDX_9548DD5D8962AD80E7D5589B ON MedicalStaff (assignRoomNo, assignRoomType);
     CREATE TABLE PrescriptionMedicine (prescription_id INT NOT NULL, medicine_id INT NOT NULL, quantity INT NOT NULL, PRIMARY KEY (prescription_id, medicine_id));
     ...
     CREATE TABLE Medicine (id INT IDENTITY NOT NULL, name NVARCHAR(30) NOT NULL, origin NVARCHAR(30) NOT NULL, price INT NOT NULL, expireDay DATE NOT NULL, PRIMARY KEY (id));
     CREATE TABLE Patient (id INT IDENTITY NOT NULL, ssn NVARCHAR(30) NOT NULL, name NVARCHAR(30) NOT NULL, gender NVARCHAR(7) NOT NULL, dob DATE NOT NULL, age INT NOT NULL, phone NVARCHAR(12) NOT NULL, noOfVisits INT NOT NULL, PRIMARY KEY (id));
