...
return function (string $databaseName, string $databaseType = 'sqlsrv', string $host = '172.22.144.1', string $port = '1433', string $uname = 'sa', string $passwd = 'sa') : EntityManager
{
    $isDevMode = true;
    $proxyDir = null;
    $cache = null;
